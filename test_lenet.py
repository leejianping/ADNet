...
from basicsr.archs.LENet_arch import LENet
...
parser.add_argument('--result_dir', default='./results/', type=str, help='Dire_ctory for results')
parser.add_argument('--weights', default='/home/tjy/ljp/qrgan/experiments/LENet/models/net_g_600000.pth', type=str, help='Path to weights')
parser.add_argument('--dataset', default='QRcode', type=str, help='Test Dataset') # ['GoPro', 'HIDE', 'RealBlur_J', 'RealBlur_R','QRcode']

args = parser.parse_args()

####### Load yaml #######change_1
yaml_file = 'options/train/train_qrnet.yml'
...
model_restoration = LENet(**x['network_g'])
...
# ==============================================================================
# NEW: Initialize variables for timing
# ==============================================================================
inference_times = []

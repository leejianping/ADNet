...
from basicsr.archs.eg_restormer_arch import QRRestormer
...
parser.add_argument('--weights', default='/home/tjy/ljp/qrgan/experiments/restormer/models/net_g_492000.pth', type=str, help='Path to weights')
...
#yaml_file = 'options/train/train_qrrestormer.yml'
import yaml
...
#model_restoration = QRRestormer(**x['network_g'])
